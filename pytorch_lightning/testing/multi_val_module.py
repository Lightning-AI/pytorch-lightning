...
class MultiValTestModel(LightningModule):
    """
    ...
    def __init__(self, hparams, force_remove_distributed_sampler=False):
        ...
        """
        # init superclass
        super(MultiValTestModel, self).__init__()
    ...
    def validation_end(self, outputs):
        ...
        for output in outputs:
            val_loss_mean1 += output['val_loss_1']
            val_acc_mean1 += output['val_acc_1']

        val_loss_mean /= len(outputs)/2
        val_acc_mean /= len(outputs)/2

        tqdm_dic = {'val_loss_1': val_loss_mean1.item(), 'val_acc_1': val_acc_mean1.item()}
        return tqdm_dic
