...
class TrainerDeprecatedAPITillVer0_8(ABC):
    ...
    def default_save_path(self):
        """Back compatibility, will be removed in v0.8.0"""
        rank_zero_warn(
            "Attribute `default_save_path` has renamed to `default_root_dir` since v0.5.x"
            " and this method will be removed in v0.8.0",
            DeprecationWarning,
        )
...
class TrainerDeprecatedAPITillVer0_9(ABC):
    ...
    def show_progress_bar(self):
        ...
        rank_zero_warn(
            "Argument `show_progress_bar` is now set by `progress_bar_refresh_rate` since v0.7.2"
