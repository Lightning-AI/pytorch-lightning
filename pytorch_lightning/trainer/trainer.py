...
class Trainer(
    ...
    def __init_profiler(self, profiler: Optional[Union[Profiler, BaseProfiler, str]]) -> None:
        ...
        self.profiler: Union[Profiler, BaseProfiler] = profiler or PassThroughProfiler()
