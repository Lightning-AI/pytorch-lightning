...
from pytorch_lightning.strategies import ParallelStrategy, SingleTPUStrategy, Strategy
...
class Trainer(
    ...
    def device_ids(self) -> List[int]:
        ...
        if isinstance(self.strategy, SingleTPUStrategy):
            return [self.strategy.device_id]
