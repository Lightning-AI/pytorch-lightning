...
class AcceleratorConnector:
    ...
    def _check_plugin_compatibility(self) -> None:
        ...
        if isinstance(self.accelerator, TPUAccelerator):
            ...
            if not isinstance(self.training_type_plugin, (SingleTPUStrategy, TPUSpawnPlugin)):
                raise ValueError(
                    "The `TPUAccelerator` can only be used with a `SingleTPUStrategy` or `TPUSpawnPlugin`,"
