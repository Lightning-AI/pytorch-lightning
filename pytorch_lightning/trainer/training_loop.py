...
class TrainLoop:
    ...
    def track_epoch_end_reduce_metrics(self, epoch_output, batch_end_outputs):
        ...
        for opt_idx, opt_outputs in enumerate(batch_end_outputs):
            ...
            if not(is_overridden("training_epoch_end", model=self.trainer.get_model())
                or not(is_overridden("on_train_epoch_end", model=self.trainer.get_model()))
                or auto_reduce_tng_result):
                continue
