...
class ConfigValidator:
    ...
    def __verify_train_loop_configuration(self, model: "pl.LightningModule") -> None:
        ...
        # -----------------------------------
        has_train_dataloader = self.trainer.data_connector._train_dataloader_source.available
    ...
    def __verify_predict_loop_configuration(self, model: "pl.LightningModule") -> None:
        has_predict_dataloader = self.trainer.data_connector._predict_dataloader_source.available
