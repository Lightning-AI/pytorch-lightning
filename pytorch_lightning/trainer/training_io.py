...
from pytorch_lightning.utilities import rank_zero_warn, is_native_amp_available, is_apex_available
...
class TrainerIOMixin(ABC):
    ...
    def restore(self, checkpoint_path: str, on_gpu: bool):
        ...
        # restore amp scaling
        if self.use_amp and is_native_amp_available() and 'native_amp_scaling_state' in checkpoint:
            self.scaler.load_state_dict(checkpoint['native_amp_scaling_state'])
        elif self.use_amp and not is_native_amp_available() and 'amp_scaling_state' in checkpoint:
    ...
    def dump_checkpoint(self, weights_only: bool = False) -> dict:
        ...
        if not weights_only:
            ...
            elif self.use_amp and not is_native_amp_available():
