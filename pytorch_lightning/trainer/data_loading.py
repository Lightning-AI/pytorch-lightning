...
class TrainerDataLoadingMixin(ABC):
    ...
    def reset_train_dataloader(self, model: Optional["pl.LightningModule"] = None) -> None:
        r"""
        .. deprecated:: v1.6
            `TrainerDataLoadingMixin.reset_train_dataloader` was deprecated in v1.6
            and will be removed in v1.8.
        ...
        """
        rank_zero_deprecation(
            "`TrainerDataLoadingMixin.reset_train_dataloader` was deprecated in v1.6 and will be removed in v1.8."
        )
        self._data_connector._reset_train_dataloader(model)

    def reset_val_dataloader(self, model: Optional["pl.LightningModule"] = None) -> None:
        r"""
        .. deprecated:: v1.6
            `TrainerDataLoadingMixin.reset_val_dataloader` was deprecated in v1.6
            and will be removed in v1.8.
        ...
        """
        rank_zero_deprecation(
            "`TrainerDataLoadingMixin.reset_val_dataloader` was deprecated in v1.6 and will be removed in v1.8."
        )
        self._data_connector._reset_val_dataloader(model)

    def reset_test_dataloader(self, model: Optional["pl.LightningModule"] = None) -> None:
        r"""
        .. deprecated:: v1.6
            `TrainerDataLoadingMixin.reset_test_dataloader` was deprecated in v1.6
            and will be removed in v1.8.
        ...
        """
        rank_zero_deprecation(
            "`TrainerDataLoadingMixin.reset_test_dataloader` was deprecated in v1.6 and will be removed in v1.8."
        )
        self._data_connector._reset_test_dataloader(model)

    def reset_predict_dataloader(self, model: Optional["pl.LightningModule"] = None) -> None:
        r"""
        .. deprecated:: v1.6
            `TrainerDataLoadingMixin.reset_predict_dataloader` was deprecated in v1.6
            and will be removed in v1.8.
        ...
        """
        rank_zero_deprecation(
            "`TrainerDataLoadingMixin.reset_predict_dataloader` was deprecated in v1.6 and will be removed in v1.8."
        )
        self._data_connector._reset_predict_dataloader(model)
