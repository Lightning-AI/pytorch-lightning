...
from pytorch_lightning.core.hooks import ModelHooks, DistributedStateHooks
...
class LightningModule(ABC, DeviceDtypeModuleMixin, GradInformation, ModelIO, ModelHooks, DistributedStateHooks, Module):
