...
class LightningModule(
    ...
    def add_to_queue(self, queue: pl.plugins.training_type.ddp_spawn._ExtraQueue) -> None:
    ...
    def get_from_queue(self, queue: pl.plugins.training_type.ddp_spawn._ExtraQueue) -> None:
