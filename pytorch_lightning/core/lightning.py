...
class LightningModule(
    ...
    def add_to_queue(self, queue: pl.strategies.executors.ddp_spawn._FakeQueue) -> None:
    ...
    def get_from_queue(self, queue: pl.strategies.executors.ddp_spawn._FakeQueue) -> None:
