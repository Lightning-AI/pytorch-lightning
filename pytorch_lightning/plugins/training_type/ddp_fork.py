...
class DDPForkPlugin(ParallelPlugin):
    """
    Forks processes using the :func:`torch.multiprocessing` method and joins processes after
    training finishes.
    """
    ...
    def start_training(self, trainer: "pl.Trainer") -> None:
        mp.start_processes(self.new_process, **self.get_mp_spawn_kwargs(trainer), start_method="fork")
    ...
    def register_plugins(cls, plugin_registry: Dict) -> None:
        plugin_registry.register(
            ...
            cls,
            description="DDPFork Plugin with `find_unused_parameters` as False",
