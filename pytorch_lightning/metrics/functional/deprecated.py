...
def to_onehot(*args, **kwargs):
    warnings.warn(
        "pytorch_lightning.metrics.functional.to_onehot is deprecated please use pytorch_lightning.metrics.utils.to_onehot",
        DeprecationWarning,
    )
...
def to_categorical(*args, **kwargs):
    warnings.warn(
        "pytorch_lightning.metrics.functional.to_categorical is deprecated please use pytorch_lightning.metrics.utils.to_categorical",
        DeprecationWarning,
    )
