...
def _mean_squared_log_error_update(preds: torch.Tensor, target: torch.Tensor):
...
def _mean_squared_log_error_compute(sum_squared_log_error: torch.Tensor, n_obs: torch.Tensor):
    return sum_squared_log_error / n_obs


def mean_squared_log_error(preds: torch.Tensor, target: torch.Tensor):
    """
