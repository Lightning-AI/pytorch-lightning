    ...
    def _format_config(self):
        if self.config is None:
            raise MisconfigurationException(
                ...
                " See: https://pytorchlightning.ai/docs/en/latest/advanced/advanced_gpu.html#deepspeed"
            )
    ...
    def save_checkpoint(self, checkpoint: Dict, filepath: _PATH, storage_options: Optional[Any] = None) -> None:
        ...
        if self.zero_stage_3 and self._multi_device and self.is_global_zero:
            warning_cache.warn(
                ...
                "see https://pytorchlightning.ai/docs/en/latest/advanced/advanced_gpu.html#"
