...
class LambdaCallback(Callback):
    ...
    def __init__(
        ...
        # need to call setattr here for mypy: https://github.com/python/mypy/issues/2427
        # TODO: Add Callable argument and return types to init signature variables
        if on_before_accelerator_backend_setup is not None:
            setattr(self, 'on_before_accelerator_backend_setup', on_before_accelerator_backend_setup)
        ...
        if on_init_start is not None:
            setattr(self, 'on_init_start', on_init_start)
        if on_init_end is not None:
            setattr(self, 'on_init_end', on_init_end)
        if on_fit_start is not None:
            setattr(self, 'on_fit_start', on_fit_start)
        if on_fit_end is not None:
            setattr(self, 'on_fit_end', on_fit_end)
        if on_sanity_check_start is not None:
            setattr(self, 'on_sanity_check_start', on_sanity_check_start)
        if on_sanity_check_end is not None:
            setattr(self, 'on_sanity_check_end', on_sanity_check_end)
        if on_train_batch_start is not None:
            setattr(self, 'on_train_batch_start', on_train_batch_start)
        if on_train_batch_end is not None:
            setattr(self, 'on_train_batch_end', on_train_batch_end)
        ...
        if on_train_epoch_end is not None:
            setattr(self, 'on_train_epoch_end', on_train_epoch_end)
        ...
        if on_validation_epoch_end is not None:
            setattr(self, 'on_validation_epoch_end', on_validation_epoch_end)
        if on_test_epoch_start is not None:
            setattr(self, 'on_test_epoch_start', on_test_epoch_start)
        if on_test_epoch_end is not None:
            setattr(self, 'on_test_epoch_end', on_test_epoch_end)
        if on_epoch_start is not None:
            setattr(self, 'on_epoch_start', on_epoch_start)
        if on_epoch_end is not None:
            setattr(self, 'on_epoch_end', on_epoch_end)
        if on_batch_start is not None:
            setattr(self, 'on_batch_start', on_batch_start)
        if on_validation_batch_start is not None:
            setattr(self, 'on_validation_batch_start', on_validation_batch_start)
        if on_validation_batch_end is not None:
            setattr(self, 'on_validation_batch_end', on_validation_batch_end)
        if on_test_batch_start is not None:
            setattr(self, 'on_test_batch_start', on_test_batch_start)
        if on_test_batch_end is not None:
            setattr(self, 'on_test_batch_end', on_test_batch_end)
        if on_batch_end is not None:
            setattr(self, 'on_batch_end', on_batch_end)
        if on_train_start is not None:
            setattr(self, 'on_train_start', on_train_start)
        if on_train_end is not None:
            setattr(self, 'on_train_end', on_train_end)
        if on_pretrain_routine_start is not None:
            setattr(self, 'on_pretrain_routine_start', on_pretrain_routine_start)
        if on_pretrain_routine_end is not None:
            setattr(self, 'on_pretrain_routine_end', on_pretrain_routine_end)
        if on_validation_start is not None:
            setattr(self, 'on_validation_start', on_validation_start)
        if on_validation_end is not None:
            setattr(self, 'on_validation_end', on_validation_end)
        if on_test_start is not None:
            setattr(self, 'on_test_start', on_test_start)
        if on_test_end is not None:
            setattr(self, 'on_test_end', on_test_end)
        if on_keyboard_interrupt is not None:
            setattr(self, 'on_keyboard_interrupt', on_keyboard_interrupt)
        if on_save_checkpoint is not None:
            setattr(self, 'on_save_checkpoint', on_save_checkpoint)
        if on_load_checkpoint is not None:
            setattr(self, 'on_load_checkpoint', on_load_checkpoint)
        if on_after_backward is not None:
            setattr(self, 'on_after_backward', on_after_backward)
        if on_before_zero_grad is not None:
            setattr(self, 'on_before_zero_grad', on_before_zero_grad)
