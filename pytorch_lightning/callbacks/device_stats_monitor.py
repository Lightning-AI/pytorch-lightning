...
class DeviceStatsMonitor(Callback):
    ...
    def on_train_batch_start(
        ...
        for logger in trainer.loggers:
            ...
            prefixed_device_stats = _prefix_metric_keys(device_stats, f"{self.__class__.__qualname__}.on_train_batch_start", separator)
    ...
    def on_train_batch_end(
        ...
        for logger in trainer.loggers:
            separator = logger.group_separator
            prefixed_device_stats = _prefix_metric_keys(device_stats, f"{self.__class__.__qualname__}.on_train_batch_end", separator)
            logger.log_metrics(prefixed_device_stats, step=trainer.fit_loop.epoch_loop._batches_that_stepped)
