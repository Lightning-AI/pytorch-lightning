...
class Callback(abc.ABC):
    ...
    def on_configure_sharded_model(self, trainer: 'Trainer', pl_module: 'LightningModule') -> None:
    ...
    def on_validation_epoch_end(self, trainer: 'Trainer', pl_module: 'LightningModule', outputs: List[Any]) -> None:
    ...
    def on_test_epoch_end(self, trainer: 'Trainer', pl_module: 'LightningModule', outputs: List[Any]) -> None:
