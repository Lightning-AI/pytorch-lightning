...
class Callback(abc.ABC):
    ...
    def on_train_epoch_end(self, trainer: pl.Trainer, pl_module: pl.LightningModule, outputs: Any) -> None:
    ...
    def on_save_checkpoint(self, trainer: pl.Trainer, pl_module: pl.LightningModule) -> None:
