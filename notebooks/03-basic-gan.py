...
# + [markdown] id="J37PBnE_x7IW" colab_type="text"
...
# + [markdown] id="kg2MKpRmybht" colab_type="text"
# ### Setup
# Lightning is easy to install. Simply `pip install pytorch-lightning`

# + id="LfrJLKPFyhsK" colab_type="code" colab={}
# ! pip install pytorch-lightning --quiet

# + id="BjEPuiVLyanw" colab_type="code" colab={}
import os
...
# + [markdown] id="OuXJzr4G2uHV" colab_type="text"
# ### MNIST DataModule
#
...
# + id="DOY_nHu328g7" colab_type="code" colab={}
...
# + [markdown] id="tW3c0QrQyF9P" colab_type="text"
# ### A. Generator

# + id="0E2QDjl5yWtz" colab_type="code" colab={}
...
# + [markdown] id="uyrltsGvyaI3" colab_type="text"
# ### B. Discriminator

# + id="Ed3MR3vnyxyW" colab_type="code" colab={}
...
# + [markdown] id="BwUMom3ryySK" colab_type="text"
# ### C. GAN
#
...
# + id="3vKszYf6y1Vv" colab_type="code" colab={}
...
# + id="Ey5FmJPnzm_E" colab_type="code" colab={}
dm = MNISTDataModule()
model = GAN(*dm.size())
trainer = pl.Trainer(gpus=1, max_epochs=5, progress_bar_refresh_rate=20)
trainer.fit(model, dm)

# + id="MlECc7cHzolp" colab_type="code" colab={}
# Start tensorboard.
