...
class DataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        return DataLoader(MinimalEspnetDataset(self.tokenizer), sampler=train_sampler, batch_size=None, num_workers=2)

    def test_dataloader(self):
        test_sampler = BucketingSampler(self.cuts_test, max_duration=400, shuffle=False, bucket_method="equal_duration")
        return DataLoader(MinimalEspnetDataset(self.tokenizer), sampler=test_sampler, batch_size=None, num_workers=2)
...
trainer = Trainer(strategy="ddp", gpus=1, logger=None, replace_sampler_ddp=False)
