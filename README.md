...
[![codecov](https://codecov.io/gh/Lightning-AI/pytorch-lightning/branch/master/graph/badge.svg)](https://codecov.io/gh/Lightning-AI/pytorch-lightning)
...
| :------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|  Linux py3.7 \[GPUs\*\*\]  |                                                                                                                             -                                                                                                                             |                                                                                                                             -                                                                                                                             |                                                                                                                 -                                                                                                                  |
| Linux py3.7 \[TPUs\*\*\*\] |                                        [![CircleCI](https://circleci.com/gh/Lightning-AI/pytorch-lightning/tree/master.svg?style=svg)](https://circleci.com/gh/Lightning-AI/pytorch-lightning/tree/master)                                        |                                                                                                                             -                                                                                                                             |                                                                                                                 -                                                                                                                  |
...
|  Linux py3.8 (with Conda)  |            [![Test](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-conda.yml/badge.svg?branch=master&event=push)](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-conda.yml)             |            [![Test](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-conda.yml/badge.svg?branch=master&event=push)](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-conda.yml)             |                                                                                                                 -                                                                                                                  |
|  Linux py3.9 (with Conda)  |                                                                                                                             -                                                                                                                             |                                                                                                                             -                                                                                                                             | [![Test](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-conda.yml/badge.svg?branch=master&event=push)](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-conda.yml) |
|      Linux py3.{7,9}       |                                                                                                                             -                                                                                                                             |                                                                                                                             -                                                                                                                             |  [![Test](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-full.yml/badge.svg?branch=master&event=push)](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-full.yml)  |
|       OSX py3.{7,9}        |                                                                                                                             -                                                                                                                             |                                                                                                                             -                                                                                                                             |  [![Test](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-full.yml/badge.svg?branch=master&event=push)](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-full.yml)  |
|     Windows py3.{7,9}      |                                                                                                                             -                                                                                                                             |                                                                                                                             -                                                                                                                             |  [![Test](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-full.yml/badge.svg?branch=master&event=push)](https://github.com/Lightning-AI/pytorch-lightning/actions/workflows/ci_test-full.yml)  |
...
![CI basic testing](https://github.com/Lightning-AI/pytorch-lightning/workflows/CI%20basic%20testing/badge.svg?branch=release%2F1.5.x&event=push)
![CI complete testing](https://github.com/Lightning-AI/pytorch-lightning/workflows/CI%20complete%20testing/badge.svg?branch=release%2F1.5.x&event=push)
![PyTorch & Conda](https://github.com/Lightning-AI/pytorch-lightning/workflows/PyTorch%20&%20Conda/badge.svg?branch=release%2F1.5.x&event=push)
![TPU tests](https://github.com/Lightning-AI/pytorch-lightning/workflows/TPU%20tests/badge.svg?branch=release%2F1.5.x&event=push)
![Docs check](https://github.com/Lightning-AI/pytorch-lightning/workflows/Docs%20check/badge.svg?branch=release%2F1.5.x&event=push)
...
```bash
pip install https://github.com/Lightning-AI/pytorch-lightning/archive/master.zip
```
...
- [Tested rigorously with every new PR](https://github.com/Lightning-AI/pytorch-lightning/tree/master/tests). We test every combination of PyTorch and Python supported versions, every OS, multi GPUs and even TPUs.
...
1. [Search through existing Discussions](https://github.com/Lightning-AI/pytorch-lightning/discussions), or [add a new question](https://github.com/Lightning-AI/pytorch-lightning/discussions/new)
