...
def test_lightning_cli_config_and_subclass_mode(tmpdir):
    input_config = {
        "fit": {
            ...
            "data": {"class_path": "pytorch_lightning.demos.boring_classes.BoringDataModule", "init_args": {"data_dir": str(tmpdir)}},
...
def test_lightning_cli_link_arguments(tmpdir):
    ...
    cli_args[-1] = "--model=pytorch_lightning.demos.boring_classes.utilities.test_cli.BoringModelRequiredClasses"
