...
- Raised an error if the `batch_size` cannot be inferred from current batch incase if its a string or some custom batch ([#10541](https://github.com/PyTorchLightning/pytorch-lightning/pull/10541))
