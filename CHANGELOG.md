...
- Return the output of the `optimizer.step`, useful for LightningLite users, manual optimization users or users overriding `LightningModule.optimizer_step` ([#11711](https://github.com/PyTorchLightning/pytorch-lightning/pull/11711))
