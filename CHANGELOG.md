...
- Deprecated `loggers.base.LightningLoggerBase` in favor of `loggers.logger.Logger`, and deprecated `loggers.base.py` in favor of `loggers.logger.py` ([#120148](https://github.com/PyTorchLightning/pytorch-lightning/pull/12014))
