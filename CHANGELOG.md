...
- The `trainer.global_step` value is now increased by one when included as part of the checkpoint's filename ([#11805](https://github.com/PyTorchLightning/pytorch-lightning/pull/11805))
