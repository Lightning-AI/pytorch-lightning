...
- Removed deprecated arguments `num_nodes` and `sync_batchnorm` from `DDPPlugin` and `DDPSpawnPlugin` ([#10357](https://github.com/PyTorchLightning/pytorch-lightning/pull/10357))
