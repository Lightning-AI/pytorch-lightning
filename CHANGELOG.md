...
- Fixed `current_epoch` and `global_step` properties mismatch between `trainer` and lightning `module` ([#3785](https://github.com/PyTorchLightning/pytorch-lightning/pull/3785))
