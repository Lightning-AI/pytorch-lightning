...
- Added a mechanism to detect `deadlock` for `DDP` and `kill the processes` when it happens ([#8167](https://github.com/PyTorchLightning/pytorch-lightning/pull/8167))
