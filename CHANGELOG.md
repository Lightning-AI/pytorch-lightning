...
- Deprecated `LightningModule.get_progress_bar_dict` and `Trainer.progress_bar_dict` in favor of `pytorch_lightning.callbacks.base.get_progress_bar_dict` and `ProgressBarBase.get_progress_bar_metrics` ([#8985](https://github.com/PyTorchLightning/pytorch-lightning/pull/8985))
