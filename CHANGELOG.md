...
- Deprecated passing `resume_from_checkpoint` to the `Trainer` constructor in favor of `trainer.fit(ckpt_path=)` ([#123](https://github.com/PyTorchLightning/pytorch-lightning/pull/123))
