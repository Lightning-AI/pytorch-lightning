...
- Changed the default value for the `progress_bar_refresh_rate` Trainer argument in Google COLAB notebooks to 20 ([#xxxx](https://github.com/PyTorchLightning/pytorch-lightning/pull/xxxx))
