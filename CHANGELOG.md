...
- Deprecated setting `seed_everything_default` in `LightningCLI` to `None`. Set it to `False` instead.  ([#12804](https://github.com/PyTorchLightning/pytorch-lightning/issues/12804)).
