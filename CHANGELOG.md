...
- Marked several `ResultCollection`, `ResultMetric`, and `ResultMetricCollection` as protected ([#11130](https://github.com/PyTorchLightning/pytorch-lightning/pull/11130))
