...
- Added an option `ckpt_path` to `LightningModule.test()` for easily loading checkpoints for testing ([#2190](https://github.com/PyTorchLightning/pytorch-lightning/pull/2190))
