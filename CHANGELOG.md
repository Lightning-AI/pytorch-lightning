...
- `precision_recall` metris is deprecated in favor of using `precision` and `recall` separately ([#4842](https://github.com/PyTorchLightning/pytorch-lightning/pull/4842))
