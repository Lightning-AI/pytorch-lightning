...
- Removed the deprecated `stochastic_weight_averaging` argument from the `Trainer` constructor ([#12535](https://github.com/PyTorchLightning/pytorch-lightning/pull/12535))
