...
- Added a private callback to manage the creation and deletion of fault-toelrance checkpoints ([#11862](https://github.com/PyTorchLightning/pytorch-lightning/pull/11862))
