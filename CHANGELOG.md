...
- The epoch start/end hooks are now called by the `FitLoop` instead of the `TrainingEpochLoop` ([#11093](https://github.com/PyTorchLightning/pytorch-lightning/pull/11093))
