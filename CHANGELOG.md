...
- Added `remove_checkpoint` to `CheckpointIO` plugin to simplify `ModelCheckpoint` Callback ([#9373](https://github.com/PyTorchLightning/pytorch-lightning/pull/9373))
