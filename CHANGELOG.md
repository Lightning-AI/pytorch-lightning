...
-  Added `Stateful` protocol to detect if classes are stateful ([#10646](https://github.com/PyTorchLightning/pytorch-lightning/issues/10646)) ([#123](https://github.com/PyTorchLightning/pytorch-lightning/issues/123))
