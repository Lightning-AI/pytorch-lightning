...
- Changed initialization of progress bar callback to avoid setting `_progress_bar_callback` attribute on Trainer ([#10553](https://github.com/PyTorchLightning/pytorch-lightning/pull/10553))
