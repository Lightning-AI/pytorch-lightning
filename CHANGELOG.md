...
- Fixed a `TypeError` when wrapping optimizers in the `HorovodPlugin` and running `Trainer.test` ([#7839](https://github.com/PyTorchLightning/pytorch-lightning/pull/7839))
