...
- Deprecated `LightningModule.get_progress_bar_dict` and `Trainer.progress_bar_dict` in favor of `ProgressBar.get_progress_bar_dict` and `ProgressBar.progress_bar_dict` ([#8985](https://github.com/PyTorchLightning/pytorch-lightning/pull/8985))
