...
- Fixed propagation of device and dtype information to submodules of LightningLite when they inherit from `DeviceDtypeModuleMixin` ([#](https://github.com/PyTorchLightning/pytorch-lightning/issues/))
