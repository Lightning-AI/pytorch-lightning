...
- Removed deprecated method and property of `accelerator_pass_through_functions` from Accelerator ([#TBD](https://github.com/PyTorchLightning/pytorch-lightning/pull/tbd))
