...
- Fixed extra `ModelCheckpoint` being added to callbacks list when resuming training from checkpoint ([#4027](https://github.com/PyTorchLightning/pytorch-lightning/issues/4027))
