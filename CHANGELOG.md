...
- Fixed memory leaks on GPU by moving `optimizer_states`, `ResultCollection extras` to `cpu`, moving `ResultMetric` attributes tensor to `cpu`, deleting `DDP Wrapper` ([#8490](https://github.com/PyTorchLightning/pytorch-lightning/pull/8490))
