...
- Refactored Loops
    ...
    * Refactored evaluation loop interface; added new classes `DataLoaderLoop`, `EvaluationDataLoaderLoop`, `EvaluationLoop` ([#7990](https://github.com/PyTorchLightning/pytorch-lightning/pull/7990))
