...
- Added `BasePredictionWriter` Callback which enable to implement how to save predictions ([#7127](https://github.com/PyTorchLightning/pytorch-lightning/pull/7127))
