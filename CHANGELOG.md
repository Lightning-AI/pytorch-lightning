...
- Fixed converting logger version from environment variable to an integer when necessary and when using DDP ([#8489](https://github.com/PyTorchLightning/pytorch-lightning/pull/8489))
