...
- Fixed check on torchmetrics logged whose `compute()` output is a multidimensional tensor ([#9582](https://github.com/PyTorchLightning/pytorch-lightning/pull/9582))
