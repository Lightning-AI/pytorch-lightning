...
- Setting `Trainer(accelerator="ddp_cpu")` now does not spawn a subprocess if `num_processes` is either kept at `1` along with `num_nodes > 1` ([#9603](https://github.com/PyTorchLightning/pytorch-lightning/pull/9603)).
