...
- Added support to `LightningModule.to_torchscript` to support custom filesystems with fsspec ([#7617](https://github.com/PyTorchLightning/pytorch-lightning/pull/7617))
