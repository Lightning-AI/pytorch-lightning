...
- Early stopping checks `on_validation_epoch_end` ([#1458](https://github.com/PyTorchLightning/pytorch-lightning/pull/1458))
...
- Fixed running `on_validation_epoch_end` only on main process in DDP ([#1125](https://github.com/PyTorchLightning/pytorch-lightning/pull/1125))
