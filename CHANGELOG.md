...
- Added corresponded tests for the CometLogger, to check the metrics in place modification ([#9150](https://github.com/PyTorchLightning/pytorch-lightning/pull/9150))
