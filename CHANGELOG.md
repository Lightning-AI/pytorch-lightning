...
- Made `max_epochs` and `min_epochs` optional in `Trainer` to allow for purely iteration based training ([#4086](https://github.com/PyTorchLightning/pytorch-lightning/pull/4086))
