...
- Deprecate `LightningDistributed` and move the broadcast logic to ddp/ddpSpawn directly ([#9691](https://github.com/PyTorchLightning/pytorch-lightning/pull/9691))
