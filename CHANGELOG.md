...
- `self.log`-ing without a `Trainer` reference now raises a warning insttead of an exception ([#9733](https://github.com/PyTorchLightning/pytorch-lightning/pull/9733))
