...
def load_readme_description(path_dir: str, homepage: str, version: str) -> str:
    ...
    text = text.replace("![PT to PL](docs/source-pytorch/_static/images/general/pl_quick_start_full_compressed.gif)", "")
    ...
    text = text.replace("docs/source-pytorch/_static/", f"{os.path.join(github_source_url, 'docs/source-app/_static/')}")
