...
You aren't forced to conform to a standardized epoch-based training loop like the one in Lightning `Trainer <https://lightning.ai/docs/pytorch/stable/common/trainer.html>`_.
...
**Maximum Control**
The Lightning `Trainer <https://lightning.ai/docs/pytorch/stable/common/trainer.html>`_ has many built-in features to make research simpler with less boilerplate, but debugging it requires some familiarity with the framework internals.
...
For alternative ways to install, read the `installation guide <https://lightning.ai/docs/pytorch/stable/starter/installation.html>`_.
