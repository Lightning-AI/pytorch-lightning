...
**Step 1:** Put your code inside a :class:`~lightning.app.core.work.LightningWork`:
...
**Step 2:** Init a :class:`~lightning.app.core.app.LightningApp` with the ``FabricMultiNode`` component.
