...
.. code-block::
    ...
    python -m lightning_pytorch.utilities.upgrade_checkpoint path/to/model.ckpt
...
.. code-block::
    ...
    python -m lightning_pytorch.utilities.upgrade_checkpoint /path/to/checkpoints/folder
