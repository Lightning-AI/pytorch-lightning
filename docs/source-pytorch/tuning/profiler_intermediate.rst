...
**************************
To understand the cost of each PyTorch operation, use the :class:`~lightning_pytorch.profilers.pytorch.PyTorchProfiler` built on top of the `PyTorch profiler <https://pytorch.org/docs/master/profiler.html>`__.
...
***************************
To profile a distributed model, use the :class:`~lightning_pytorch.profilers.pytorch.PyTorchProfiler` with the *filename* argument which will save a report per rank.
...
*****************************
To visualize the profiled operations, enable **emit_nvtx** in the :class:`~lightning_pytorch.profilers.pytorch.PyTorchProfiler`.
