...
#########################################
Add Components made by others to your App
#########################################
...
However, someone who wants to use this App (maybe you) found `Lightning HPO <https://lightning.ai/component/BA2slXI093-Lightning%20HPO>`_
...
.. customcalloutitem::
   :header: Level-up your App skills
