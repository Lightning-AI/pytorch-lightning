...
To enable pruning during training in Lightning, simply pass in the :class:`~lightning_pytorch.callbacks.ModelPruning` callback to the Lightning Trainer. PyTorch's native pruning implementation is used under the hood.
...
.. code-block:: python
    ...
    from lightning_pytorch.callbacks import ModelPruning
