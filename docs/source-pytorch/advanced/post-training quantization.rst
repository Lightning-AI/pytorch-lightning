...
::
    ...
    pip install numpy pandas pyyaml scikit-learn scikit-image matplotlib schema py-cpuinfo contextlib2 requests Flask Flask-Cors Flask-SocketIO gevent gevent-websocket psutil Pillow pycocotools-windows; sys_platform != 'linux' pycocotools; sys_platform == 'linux' opencv-python prettytable cryptography sqlalchemy==1.4.27 alembic==1.7.7 pywin32; sys_platform != 'linux' deprecated
...
--------------------
The model is fed into Intel Neural Compressor and conduct model quantization:
::
