...
:meth:`~lightning_pytorch.callbacks.Callback.state_dict` and :meth:`~lightning_pytorch.callbacks.Callback.load_state_dict`.
...
the callback must define a :attr:`~lightning_pytorch.callbacks.Callback.state_key` property in order for Lightning
...
The implementation of a :attr:`~lightning_pytorch.callbacks.Callback.state_key` is essential here. If it were missing,
Lightning would not be able to disambiguate the state for these two callbacks, and :attr:`~lightning_pytorch.callbacks.Callback.state_key`
