...
As part of our commitment to extensibility, we have abstracted Lightning's checkpointing logic into the :class:`~lightning_pytorch.plugins.io.CheckpointIO` plugin.
