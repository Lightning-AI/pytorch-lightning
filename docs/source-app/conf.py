...
nitpick_ignore = [
    ...
    ('py:class', 'lightning.structures.Dict'),
    ('py:class', 'lightning.structures.List'),
    ('py:class', 'lightning.utilities.packaging.app_config.AppConfig'),
    ('py:class', 'lightning.utilities.packaging.cloud_compute.CloudCompute'),
