...
.. code-block:: console
    ...
    $ lightning run app docs/source-LAI/cod_samples/quickstart/app_01.py
...
.. code-block:: console
    ...
    $ lightning run app docs/source-LAI/code_samples/quickstart/app_02.py
      INFO: Your app has started. View it in your browser: http://127.0.0.1:7501/view
      # After you have clicked `run` on the UI.
      0.0 0.0
      ...
...
.. code-block:: console
    ...
    $ lightning run app docs/source-LAI/code_samples/quickstart/app/app_0.py
      INFO: Your app has started. View it in your browser: http://127.0.0.1:7501/view
      # After you have clicked `run` on the UI.
      0.0, 0.0
      ...
