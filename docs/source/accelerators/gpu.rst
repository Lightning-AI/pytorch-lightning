...
Lightning allows explicitly specifying the backend via the `pg_backend` constructor argument on the relevant Strategy classes.
...
.. code-block:: python
    ...
    ddp = DDPStrategy(pg_backend="gloo")
