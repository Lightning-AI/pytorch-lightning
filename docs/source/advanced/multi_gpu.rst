...
The ``sync_dist`` option can also be used in logging calls during training, but be aware that this can lead to significant communication overhead and slow down your training.
