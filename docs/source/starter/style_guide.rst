...
- `Introduction to PyTorch Lightning <https://pytorchlightning.ai/docs/en/stable/notebooks/lightning_examples/mnist-hello-world.html>`_
- `Introduction to DataModules <https://pytorchlightning.ai/docs/en/stable/notebooks/lightning_examples/datamodules.html>`_
