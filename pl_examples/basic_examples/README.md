...
The transition through [LightningLite](https://pytorchlightning.ai/docs/en/stable/starter/lightning_lite.rst) from pure PyTorch is optional but it might be helpful to learn about it.
