...
scheduler = torch.profiler.schedule(wait=2, warmup=1, active=5)
trainer = Trainer(max_epochs=1, limit_train_batches=15, gpus=1, profiler=PyTorchProfiler(schedule=scheduler))
