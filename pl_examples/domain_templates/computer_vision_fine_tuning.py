...
def freeze(module: torch.nn.Module, n: Optional[int] = None, train_bn: bool = True) -> None:
...
def _unfreeze_and_add_param_group(
    module: torch.nn.Module, optimizer: Optimizer, lr: Optional[float] = None, train_bn: bool = True
):
