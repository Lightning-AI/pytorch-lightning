...
def optimize_on_cluster(hyperparams):
    ...
    cluster.optimize_parallel_cluster_gpu(
        main, nb_trials=hyperparams.nb_hopt_trials, job_name=hyperparams.experiment_name
    )
...
if __name__ == "__main__":
    ...
    parent_parser.add_argument(
        "--gpu_partition", type=str, help="consult your cluster manual"
    )

    # TODO: make 1 param
    parent_parser.add_argument(
        "--per_experiment_nb_gpus", type=int, help="how many gpus to use in a node"
    )
    parent_parser.add_argument(
    ...
    parent_parser.add_argument(
        "--nb_gpu_nodes", type=int, default=1, help="how many nodes to use in a cluster"
    )
    parent_parser.add_argument(
        "--test_tube_save_path",
        type=str,
