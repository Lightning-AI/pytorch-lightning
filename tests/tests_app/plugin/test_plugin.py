...
from lightning_app.plugin.plugin import _Run, _start_plugin_server


@pytest.fixture()
@mock.patch("lightning_app.plugin.plugin.uvicorn")
...
@mock.patch("lightning_app.plugin.plugin.requests")
...
from lightning_app.plugin.actions import Toast
from lightning_app.plugin.plugin import LightningPlugin
...
from lightning_app.plugin.actions import NavigateTo
from lightning_app.plugin.plugin import LightningPlugin
...
@mock.patch("lightning_app.runners.cloud.CloudRuntime")
@mock.patch("lightning_app.plugin.plugin.requests")
