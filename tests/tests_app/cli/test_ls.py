...
from lightning_cloud.openapi import V1ListMembershipsResponse, V1Membership, Externalv1LightningappInstance, V1ListLightningappInstancesResponse, V1ListLightningappInstanceArtifactsResponse, V1LightningappInstanceArtifact
import os
...
def test_ls(monkeypatch):
    ...
    client.lightningapp_instance_service_list_lightningapp_instance_artifacts.return_value = V1ListLightningappInstanceArtifactsResponse(
        artifacts=[
