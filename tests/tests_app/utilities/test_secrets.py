...
@mock.patch("lightning_" + "app.utilities.network.GridRestClient.secret_service_list_secrets")
@mock.patch("lightning_" + "app.utilities.network.GridRestClient.projects_service_list_memberships")
