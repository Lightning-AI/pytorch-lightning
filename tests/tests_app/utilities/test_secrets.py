...
@mock.patch("lightning_app.utilities.secrets.LightningClient.secret_service_list_secrets")
@mock.patch("lightning_app.utilities.secrets.LightningClient.projects_service_list_memberships")
