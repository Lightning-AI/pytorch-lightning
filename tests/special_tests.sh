...
python ${DEFAULTS} pytest tests/trainer/test_trainer.py::test_trainer_predict_ddp
python ${DEFAULTS} pytest tests/trainer/test_trainer.py::test_trainer_predict_dp
