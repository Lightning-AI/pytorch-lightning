...
@pytest.mark.parametrize('method', ['fit', 'test'])
@pytest.mark.skipif(torch.cuda.device_count() < 2, reason="test requires multi-GPU machine")
def test_multi_gpu_model_ddp_fit_only(tmpdir, cli_args, method):
    # call the script
    call_training_script(ddp_model, cli_args, method, tmpdir)
