...
def test_accelerator_on_reset_dataloader_hooks(tmpdir):
    """
    Ensures data-loader hooks are called at the right stages when using an accelerator.
    """
    ...
    assert accelerator.mock_count == 4
    ...
    assert accelerator.mock_count == 3


def test_plugin_on_reset_dataloader_hooks(tmpdir):
    """
    Ensures data-loader hooks are called at the right stages when using a plugin.
    """
