...
from lightning.fabric.plugins import DoublePrecision, HalfPrecision, MixedPrecision, Precision, XLAPrecision, FSDPPrecision, DeepSpeedPrecision
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("32-true", "fsdp", FSDPPrecision, marks=RunIf(min_torch="1.12")),
        pytest.param("16-true", "fsdp", FSDPPrecision, marks=RunIf(min_torch="1.12")),
        pytest.param("bf16-true", "fsdp", FSDPPrecision, marks=RunIf(min_torch="1.12")),
        pytest.param("16-mixed", "fsdp", FSDPPrecision, marks=RunIf(min_torch="1.12")),
        pytest.param("bf16-mixed", "fsdp", FSDPPrecision, marks=RunIf(min_torch="1.12")),
