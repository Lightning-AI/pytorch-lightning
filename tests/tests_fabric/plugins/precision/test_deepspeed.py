...
def test_deepspeed_precision_apex_not_installed(monkeypatch):
    import lightning_fabric.plugins.precision.deepspeed as deepspeed
...
@mock.patch("lightning_fabric.plugins.precision.deepspeed._APEX_AVAILABLE", return_value=True)
