...
def run_test_from_config(trainer_options, on_gpu, check_size=True):
    ...
    class TestModel(BoringModel):
        ...
        def on_train_start(self) -> None:
            ...
            self.initial_cuda_memory = torch.cuda.memory_allocated(trainer.local_rank)
    ...
    assert torch.cuda.memory_allocated(trainer.local_rank) <= model.initial_cuda_memory
