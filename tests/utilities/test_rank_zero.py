...
@pytest.mark.parametrize("rank_key,rank", [("RANK", "1"), ("SLURM_PROCID", "2"), ("LOCAL_RANK", "3"), ("JSM_NAMESPACE_RANK", "4")])
...
@pytest.mark.parametrize(
    ...
    [
        ({"SLURM_PROCID": "3"}, 3),
        ({"SLURM_PROCID": "3", "LOCAL_RANK": "2"}, 2),
        ({"SLURM_PROCID": "3", "LOCAL_RANK": "2", "RANK": "1"}, 1),
        ({"SLURM_PROCID": "3", "LOCAL_RANK": "2", "RANK": "1"}, {"JSM_NAMESPACE_RANK", "0"}, 0),
    ],
)
