...
standalone: bool = os.getenv("PL_RUN_STANDALONE_TESTS", "0") == "1"
if standalone:
    ...
    lightning_logger: logging.Logger = logging.getLogger("pytorch_lightning")
    ...
    handler: logging.Handler = lightning_logger.handlers[0]
