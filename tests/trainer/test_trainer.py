...
def test_gradient_clipping(tmpdir):
    ...
    old_training_step_and_backward = trainer.batch_loop.training_step_and_backward
    ...
    trainer.batch_loop.training_step_and_backward = training_step_and_backward
    # for the test
...
def test_num_sanity_val_steps_neg_one(tmpdir, limit_val_batches):
    ...
    with patch.object(
        trainer.evaluation_loop.evaluation_loop, "evaluation_step", wraps=trainer.evaluation_loop.evaluation_loop.evaluation_step
    ) as mocked:
