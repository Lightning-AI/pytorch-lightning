...
def test_gradient_clipping(tmpdir):
    ...
    old_training_step_and_backward = trainer.training_batch_loop.training_step_and_backward
    ...
    trainer.training_batch_loop.training_step_and_backward = training_step_and_backward
    # for the test
