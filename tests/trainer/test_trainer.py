...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            dict(_distrib_type=None, _accelerator_type=_AcceleratorType.CPU, num_gpus=0, num_processes=1),
        ),
        (
        ...
        (
            ...
            dict(_distrib_type=_StrategyType.DDP, _accelerator_type=_AcceleratorType.CPU, num_gpus=0, num_processes=2),
        ),
        (
            dict(accelerator="ddp", num_nodes=2, gpus=None),
            dict(_distrib_type=_StrategyType.DDP, _accelerator_type=_AcceleratorType.CPU, num_gpus=0, num_processes=1),
        ),
        (
            dict(accelerator="ddp_cpu", num_processes=2, gpus=None),
            dict(
                _distrib_type=_StrategyType.DDP_SPAWN,
                _accelerator_type=_AcceleratorType.CPU,
                num_gpus=0,
                num_processes=2,
            ),
        ),
        ...
        (
            ...
            dict(_distrib_type=None, _accelerator_type=_AcceleratorType.GPU, num_gpus=1, num_processes=1),
        ),
        (
            dict(accelerator="dp", gpus=1),
            dict(_distrib_type=_StrategyType.DP, _accelerator_type=_AcceleratorType.GPU, num_gpus=1, num_processes=1),
        ),
        (
            dict(accelerator="ddp", gpus=1),
            dict(_distrib_type=_StrategyType.DDP, _accelerator_type=_AcceleratorType.GPU, num_gpus=1, num_processes=1),
        ),
        (
        ...
        (
            ...
            dict(_distrib_type=_StrategyType.DDP2, _accelerator_type=_AcceleratorType.GPU, num_gpus=1, num_processes=1),
        ),
        (
            dict(accelerator=None, gpus=2),
            dict(
                _distrib_type=_StrategyType.DDP_SPAWN,
                _accelerator_type=_AcceleratorType.GPU,
                num_gpus=2,
                num_processes=2,
            ),
        ),
        (
            ...
            dict(_distrib_type=_StrategyType.DP, _accelerator_type=_AcceleratorType.GPU, num_gpus=2, num_processes=1),
        ),
        (
            dict(accelerator="ddp", gpus=2),
            dict(_distrib_type=_StrategyType.DDP, _accelerator_type=_AcceleratorType.GPU, num_gpus=2, num_processes=2),
        ),
        (
            dict(accelerator="ddp2", gpus=2),
            dict(_distrib_type=_StrategyType.DDP2, _accelerator_type=_AcceleratorType.GPU, num_gpus=2, num_processes=1),
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            dict(_distrib_type=_StrategyType.DDP, _accelerator_type=_AcceleratorType.GPU, num_gpus=2, num_processes=1),
        ),
        (
        ...
        (
            ...
            dict(
                _distrib_type=_StrategyType.DDP_SHARDED,
                _accelerator_type=_AcceleratorType.GPU,
                num_gpus=2,
                num_processes=1,
            ),
