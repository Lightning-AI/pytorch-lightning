...
def test_v1_8_0_deprecated_test_tube_logger_experiment():
    with pytest.deprecated_call(
        ...
        logger = _instantiate_logger(TestTubeLogger, save_dir="test", prefix="tmp")
        _ = logger.experiment


def test_v1_8_0_deprecated_wandb_logger_experiment():
    with pytest.deprecated_call(
        match=(
            """
        ...
        logger = _instantiate_logger(WandbLogger, save_dir="test", prefix="tmp")
        _ = logger.experiment
