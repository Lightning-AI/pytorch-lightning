...
def test_create_group():
    ...
    with mock.patch("lightning_lite.plugins.collectives.single_device.SingleDeviceCollective.new_group") as new_mock:
        collective.create_group(arg1=15, arg3=10)

    group_kwargs = {"arg3": 10, "arg1": 15}
    new_mock.assert_called_once_with(**group_kwargs)

    with mock.patch("lightning_lite.plugins.collectives.single_device.SingleDeviceCollective.destroy_group"):
        collective.teardown()
