...
from pytorch_lightning.accelerators.plugins.precision import ApexMixedPrecisionPlugin
...
def test_amp_choice_default_ddp_cpu(tmpdir, ddp_backend, gpus, num_processes):
    ...
    class CB(Callback):
        def on_fit_start(self, trainer, pl_module):
            assert isinstance(trainer.precision_connector.backend, ApexMixedPrecisionPlugin)
            raise SystemExit()
