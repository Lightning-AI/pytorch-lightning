...
from pytorch_lightning.plugins import DDP2Plugin, DDPPlugin, DDPShardedStrategy, DeepSpeedPlugin
...
@pytest.mark.parametrize(
    "plugin_cls",
    [DDPPlugin, DDPShardedStrategy, DDP2Plugin, pytest.param(DeepSpeedPlugin, marks=RunIf(deepspeed=True))],
)
