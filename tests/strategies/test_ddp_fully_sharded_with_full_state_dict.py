...
class TestFSDPModel(BoringModel):
    ...
    def _assert_layer_fsdp_instance(self) -> None:
        ...
        # Assert reshard_after_forward has been set and captured after FullyShardedDataParallel calls _reset_lazy_init
        assert self.layer.reshard_after_forward is True
