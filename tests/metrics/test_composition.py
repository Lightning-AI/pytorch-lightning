...
@pytest.mark.parametrize(['second_operand', 'expected_result'],[
...
@pytest.mark.parametrize(['second_operand', 'expected_result'],[
    (DummyMetric([2, 2, 2]), torch.tensor(12)),
    (torch.tensor([2,2,2]), torch.tensor(12))
])
...
@pytest.mark.parametrize(['second_operand', 'expected_result'],[
    (DummyMetric([1, 0, 3]), torch.tensor([-1, -2, 3])),
    (torch.tensor([1, 0, 3]), torch.tensor([-1, -2, 3]))
])
...
@pytest.mark.parametrize(['second_operand', 'expected_result'],[
    (DummyMetric([1, 0, 3]), torch.tensor([-2, -2, 0])),
    (torch.tensor([1, 0, 3]), torch.tensor([-2, -2, 0]))
])
