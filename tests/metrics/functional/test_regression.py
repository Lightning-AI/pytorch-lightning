...
@pytest.mark.parametrize(
    ...
    [pytest.param([0.0, 1, 2, 3], [0.0, 1, 2, 2], 0.25), pytest.param([4.0, 3, 2, 1], [1.0, 4, 3, 2], 3.0),],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param([0.0, 1, 2, 3], [0.0, 1, 2, 3], 0.0),
        pytest.param([0.0, 1, 2, 3], [0.0, 1, 2, 2], 0.0207),
        pytest.param([4.0, 3, 2, 1], [1.0, 4, 3, 2], 0.2841),
    ],
)
