...
def test_precision_plugin_renamed_imports():
    # base class
    from lightning_pytorch.plugins import PrecisionPlugin as PrecisionPlugin2
    from lightning_pytorch.plugins.precision import PrecisionPlugin as PrecisionPlugin1
    from lightning_pytorch.plugins.precision.precision import Precision
    from lightning_pytorch.plugins.precision.precision_plugin import PrecisionPlugin as PrecisionPlugin0
    ...
    # bitsandbytes
    from lightning_pytorch.plugins import BitsandbytesPrecisionPlugin as BnbPlugin2
    from lightning_pytorch.plugins.precision import BitsandbytesPrecisionPlugin as BnbPlugin1
    from lightning_pytorch.plugins.precision.bitsandbytes import BitsandbytesPrecision
    from lightning_pytorch.plugins.precision.bitsandbytes import BitsandbytesPrecisionPlugin as BnbPlugin0
    ...
    # deepspeed
    from lightning_pytorch.plugins import DeepSpeedPrecisionPlugin as DeepSpeedPlugin2
    from lightning_pytorch.plugins.precision import DeepSpeedPrecisionPlugin as DeepSpeedPlugin1
    from lightning_pytorch.plugins.precision.deepspeed import DeepSpeedPrecision
    from lightning_pytorch.plugins.precision.deepspeed import DeepSpeedPrecisionPlugin as DeepSpeedPlugin0
    ...
    # double
    from lightning_pytorch.plugins import DoublePrecisionPlugin as DoublePlugin2
    from lightning_pytorch.plugins.precision import DoublePrecisionPlugin as DoublePlugin1
    from lightning_pytorch.plugins.precision.double import DoublePrecision
    from lightning_pytorch.plugins.precision.double import DoublePrecisionPlugin as DoublePlugin0
    ...
    # fsdp
    from lightning_pytorch.plugins import FSDPPrecisionPlugin as FSDPPlugin2
    from lightning_pytorch.plugins.precision import FSDPPrecisionPlugin as FSDPPlugin1
    from lightning_pytorch.plugins.precision.fsdp import FSDPPrecision
    from lightning_pytorch.plugins.precision.fsdp import FSDPPrecisionPlugin as FSDPPlugin0
    ...
    # half
    from lightning_pytorch.plugins import HalfPrecisionPlugin as HalfPlugin2
    from lightning_pytorch.plugins.precision import HalfPrecisionPlugin as HalfPlugin1
    from lightning_pytorch.plugins.precision.half import HalfPrecision
    from lightning_pytorch.plugins.precision.half import HalfPrecisionPlugin as HalfPlugin0
    ...
    # mixed
    from lightning_pytorch.plugins import MixedPrecisionPlugin as MixedPlugin2
    from lightning_pytorch.plugins.precision import MixedPrecisionPlugin as MixedPlugin1
    from lightning_pytorch.plugins.precision.amp import MixedPrecision
    from lightning_pytorch.plugins.precision.amp import MixedPrecisionPlugin as MixedPlugin0
    ...
    # transformer_engine
    from lightning_pytorch.plugins import TransformerEnginePrecisionPlugin as TEPlugin2
    from lightning_pytorch.plugins.precision import TransformerEnginePrecisionPlugin as TEPlugin1
    from lightning_pytorch.plugins.precision.transformer_engine import TransformerEnginePrecision
    from lightning_pytorch.plugins.precision.transformer_engine import TransformerEnginePrecisionPlugin as TEPlugin0
    ...
    # xla
    from lightning_pytorch.plugins import XLAPrecisionPlugin as XLAPlugin2
    from lightning_pytorch.plugins.precision import XLAPrecisionPlugin as XLAPlugin1
    from lightning_pytorch.plugins.precision.xla import XLAPrecision
    from lightning_pytorch.plugins.precision.xla import XLAPrecisionPlugin as XLAPlugin0
