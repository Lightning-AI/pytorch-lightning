...
from lightning.pytorch.utilities.data.fileio import is_url, is_path, open_single_file, path_to_url, OpenCloudFileObj
...
@pytest.mark.parametrize("path,bucket_name,bucket_root_path,expected",[
