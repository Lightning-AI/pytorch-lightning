...
import pytest
import torch
from lightning_pytorch.utilities.upgrade_checkpoint import main as upgrade_main
...
@mock.patch("lightning_pytorch.utilities.upgrade_checkpoint.torch.save")
@mock.patch("lightning_pytorch.utilities.upgrade_checkpoint.torch.load")
@mock.patch("lightning_pytorch.utilities.upgrade_checkpoint.migrate_checkpoint")
