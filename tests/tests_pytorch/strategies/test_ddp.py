...
@RunIf(
    skip_windows=True, max_torch="2.0.0"
)  # Todo: `AttributeError: module 'torch._C' has no attribute '_cuda_clearCublasWorkspaces'`
...
@mock.patch("pytorch_lightning.accelerators.cuda._clear_cuda_memory")
