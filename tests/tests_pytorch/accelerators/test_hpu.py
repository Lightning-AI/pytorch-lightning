...
from pytorch_lightning import Callback, seed_everything, Trainer, LightningDataModule
...
def test_hpu_datamodule_unsupported_transforms():
    ...
    trainer = Trainer(devices=1, accelerator="hpu", max_epochs=1, precision=32, max_steps=1, limit_test_batches=0.1, limit_val_batches=0.1)
