...
def test_dm_init_from_datasets_dataloaders(iterable):
    ...
    with pytest.raises(_NotImplementedError, match="`val_dataloader` must be implemented"):
        _ = dm.val_dataloader()
    with pytest.raises(_NotImplementedError, match="`test_dataloader` must be implemented"):
    ...
    with pytest.raises(_NotImplementedError, match="`train_dataloader` must be implemented"):
