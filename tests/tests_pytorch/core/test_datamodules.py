...
def test_train_loop_only(tmpdir):
    ...
    trainer = Trainer(accelerator="auto", default_root_dir=tmpdir, max_epochs=1, enable_model_summary=False)
...
def test_full_loop(tmpdir):
    ...
    trainer = Trainer(
        accelerator="auto", default_root_dir=tmpdir, max_epochs=1, enable_model_summary=False, deterministic=True
    )
