...
@mock.patch.dict(os.environ, {"AZ_BATCH_MASTER_NODE": "1.2.3.4:500", "OMPI_COMM_WORLD_LOCAL_RANK": "1",
     "OMPI_COMM_WORLD_RANK": "5", "OMPI_COMM_WORLD_SIZE" : "6"})
...
@mock.patch.dict(os.environ, {"AZ_BATCHAI_MPI_MASTER_NODE": "1.2.3.4", "OMPI_COMM_WORLD_LOCAL_RANK": "1",
     "OMPI_COMM_WORLD_RANK": "5", "OMPI_COMM_WORLD_SIZE" : "6"})
...
def test_detect():
    ...
    with mock.patch.dict(os.environ, {"AZ_BATCHAI_MPI_MASTER_NODE": "1.2.3.4", "OMPI_COMM_WORLD_LOCAL_RANK": "1",
     "OMPI_COMM_WORLD_RANK": "2", "OMPI_COMM_WORLD_SIZE" : "6"}, clear=True):
