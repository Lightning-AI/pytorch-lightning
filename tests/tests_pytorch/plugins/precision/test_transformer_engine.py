...
from lightning_pytorch.plugins import TransformerEnginePrecision
from lightning_pytorch.trainer.connectors.accelerator_connector import _AcceleratorConnector
