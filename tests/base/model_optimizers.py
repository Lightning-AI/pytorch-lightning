...
class ConfigureOptimizersPool(ABC):
    ...
    def configure_optimizers(self):
        ...
        """
        optimizer = optim.Adam(self.parameters(), lr=self.module_hparams.learning_rate)
        return optimizer
    ...
    def configure_optimizers__lbfgs(self):
        ...
        :return: list of optimizers
        """
        optimizer = optim.LBFGS(self.parameters(), lr=self.module_hparams.learning_rate)
        return optimizer
    ...
    def configure_optimizers__multiple_optimizers(self):
        ...
        optimizer1 = optim.Adam(self.parameters(), lr=self.module_hparams.learning_rate)
        optimizer2 = optim.Adam(self.parameters(), lr=self.module_hparams.learning_rate)
    ...
    def configure_optimizers__param_groups(self):
        param_groups = [
            {'params': list(self.parameters())[:2], 'lr': self.module_hparams.learning_rate * 0.1},
            {'params': list(self.parameters())[2:], 'lr': self.module_hparams.learning_rate}
        ]
