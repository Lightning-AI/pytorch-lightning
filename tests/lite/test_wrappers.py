...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("bf16", torch.float32, torch.bfloat16, marks=RunIf(min_torch="1.10", bf16=True)),
        pytest.param("bf16", torch.float64, torch.bfloat16, marks=RunIf(min_torch="1.10", bf16=True)),
        pytest.param("bf16", torch.bool, torch.bool, marks=RunIf(min_torch="1.10", bf16=True)),
    ],
)
