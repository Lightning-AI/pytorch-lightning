...
from lightning.data.streaming.constants import (
    _INDEX_FILENAME,
    _LIGHTNING_CLOUD_GREATER_EQUAL_0_5_51,
...
class Cache:
    def __init__(
        ...
        if not _LIGHTNING_CLOUD_GREATER_EQUAL_0_5_51:
            raise ModuleNotFoundError("Lightning Cloud 0.5.51 or higher is required to use the cache.")
