# Taken from PyTorch https://github.com/pytorch/pytorch/blob/e9ebda29d87ce0916ab08c06ab26fd3766a870e5/torch/utils/_pytree.py
# This should be available in 2.0.2
# TODO: Remove me when open sourced.

import dataclasses
import json
import warnings
from collections import OrderedDict, namedtuple
from typing import Any, Callable, Dict, List, NamedTuple, Optional, Tuple, Type, TypeVar, Union, cast, overload
...
def _register_pytree_node(
    ...
    *,
    ...
    if (to_dumpable_context is None) ^ (from_dumpable_context is None):
        raise ValueError(f"Both to_dumpable_context and from_dumpable_context for {typ} must " "be None or registered.")

    type_fqn = f"{typ.__module__}.{typ.__name__}"
    serialize_node_def = _SerializeNodeDef(typ, type_fqn, to_dumpable_context, from_dumpable_context)
...
def map_only(ty: TypeAny) -> MapOnlyFn[FnAny[Any]]:
    """Suppose you are writing a tree_map over tensors, leaving everything else unchanged.  Ordinarily you would have
    to write:
