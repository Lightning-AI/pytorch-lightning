...
theme = gradio.themes.Default(
    primary_hue=gradio.themes.Color("#ffffff", "#e9d5ff", "#d8b4fe", "#c084fc", "#fcfcfc", "#a855f7", "#9333ea", "#8823e1", "#6b21a8", "#2c2730", "#1c1c1c"),
    secondary_hue=gradio.themes.Color("#c3a1e8", "#e9d5ff", "#d3bbec", "#c795f9", "#9174af", "#a855f7", "#9333ea", "#6700c2", "#000000", "#991ef1", "#33243d"),
    neutral_hue=gradio.themes.Color("#ede9fe", "#ddd6fe", "#c4b5fd", "#a78bfa", "#fafafa", "#8b5cf6", "#7c3aed", "#6d28d9", "#6130b0", "#8a4ce6", "#3b3348"),
).set(
    body_background_fill='*primary_50',
    body_background_fill_dark='*primary_950',
    body_text_color_dark='*primary_100',
