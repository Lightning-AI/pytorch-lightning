...
LIGHTNING_IN_CLOUDSPACE = os.getenv("LIGHTNING_IN_CLOUDSPACE", False)
LIGHTNING_CLOUDSPACE_EXPOSED_PORT_COUNT = os.getenv("LIGHTNING_CLOUDSPACE_EXPOSED_PORT_COUNT")
