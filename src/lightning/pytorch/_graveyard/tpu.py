...
from lightning_pytorch.plugins.precision import XLAPrecision
from lightning_pytorch.strategies.single_xla import SingleDeviceXLAStrategy
from lightning_pytorch.utilities.rank_zero import rank_zero_deprecation


def _patch_sys_modules() -> None:
    self = sys.modules[__name__]
    sys.modules["lightning_pytorch.strategies.single_tpu"] = self
    sys.modules["lightning_pytorch.accelerators.tpu"] = self
    sys.modules["lightning_pytorch.plugins.precision.tpu"] = self
    sys.modules["lightning_pytorch.plugins.precision.tpu_bf16"] = self
    sys.modules["lightning_pytorch.plugins.precision.xlabf16"] = self


class SingleTPUStrategy(SingleDeviceXLAStrategy):
    """Legacy class.

    Use :class:`~lightning_pytorch.strategies.single_xla.SingleDeviceXLAStrategy` instead.
...
class TPUAccelerator(XLAAccelerator):
    ...
    Use :class:`~lightning_pytorch.accelerators.xla.XLAAccelerator` instead.

    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        rank_zero_deprecation(
            "The `TPUAccelerator` class is deprecated. Use `lightning_pytorch.accelerators.XLAAccelerator` instead."
        )
        super().__init__(*args, **kwargs)
...
class TPUPrecisionPlugin(XLAPrecision):
    ...
    Use :class:`~lightning_pytorch.plugins.precision.xla.XLAPrecision` instead.

    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        rank_zero_deprecation(
            "The `TPUPrecisionPlugin` class is deprecated. Use `lightning_pytorch.plugins.precision.XLAPrecision`"
            " instead."
        )
...
class TPUBf16PrecisionPlugin(XLAPrecision):
    ...
    Use :class:`~lightning_pytorch.plugins.precision.xlabf16.XLAPrecision` instead.
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        rank_zero_deprecation(
            ...
            " `lightning_pytorch.plugins.precision.XLAPrecision` instead."
        )
