...
from lightning_pytorch.utilities.imports import _TORCHMETRICS_GREATER_EQUAL_0_8_0
from lightning_pytorch.utilities.migration.utils import _patch_pl_to_mirror_if_necessary
...
if not _TORCHMETRICS_GREATER_EQUAL_0_8_0:
    # up to v0.8.0 torchmetrics had a hardcoded reference to lightning_pytorch which has to be redirected to the
