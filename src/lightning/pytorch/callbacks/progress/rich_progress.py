...
class RichProgressBar(ProgressBarBase):
    ...
    def on_train_batch_end(
        ...
        self._update(self.train_progress_bar_id, batch_idx)
        self._update_metrics(trainer, pl_module)
        self.refresh()
    ...
    def on_validation_batch_end(
        ...
        if self.is_disabled:
            return
        if trainer.sanity_checking:
            self._update(self.val_sanity_progress_bar_id, batch_idx)
        elif self.val_progress_bar_id is not None:
            self._update(self.val_progress_bar_id, batch_idx)
        self.refresh()
    ...
    def on_test_batch_end(
        ...
        if self.is_disabled:
            return
        assert self.test_progress_bar_id is not None
        self._update(self.test_progress_bar_id, batch_idx)
        self.refresh()
    ...
    def on_predict_batch_end(
        ...
        self._update(self.predict_progress_bar_id, batch_idx)
        self.refresh()
