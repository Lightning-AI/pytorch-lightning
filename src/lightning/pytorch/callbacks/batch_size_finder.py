...
class BatchSizeFinder(Callback):
    """Attempts to find the largest batch size for a given model that avoids an out of memory (OOM) error.
    All you need to do is add it as a callback inside Trainer and call
