...
class BatchSizeFinder(Callback):
    """This callback finds the largest batch size supported by a given model before an out of memory (OOM) error is
    thrown. All you need to do is add it as a callback inside Trainer and call ``trainer.{fit,validate,test,predict}``.
