...
- Fixed dataloader not reloading when resuming from checkpoint with `reload_dataloaders_every_n_epochs` ([#21514](https://github.com/Lightning-AI/pytorch-lightning/pull/21514))
