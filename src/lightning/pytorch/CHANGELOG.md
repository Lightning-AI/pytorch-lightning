...
- Added support for mixed 8-bit precision as `Trainer(plugins=TransformerEnginePrecisionPlugin())` using [Nvidia's Transformer Engine](https://docs.nvidia.com/deeplearning/transformer-engine) ([#18459](https://github.com/Lightning-AI/lightning/pull/18459))
