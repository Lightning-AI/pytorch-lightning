...
- Added support for returning `LRSchedulerConfig` from `LightningModule.configure_optimizers` ([#21803](https://github.com/Lightning-AI/pytorch-lightning/pull/21803))
