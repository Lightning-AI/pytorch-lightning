...
- Fixed `save_hyperparameters(ignore=...)`behavior so subclass ignore rules override base class rules (#[21488](https://github.com/Lightning-AI/pytorch-lightning/pull/21490))
