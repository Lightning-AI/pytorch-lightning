...
- Avoid LightningCLI saving hyperparameters with `class_path` and `init_args` which is a breaking change ([#???](https://github.com/Lightning-AI/pytorch-lightning/pull/???))
