...
- Added an argument `include_cuda` in `lightning.pytorch.utilities.seed.isolate_rng` to disable managing `torch.cuda`'s rng ([#16423](https://github.com/Lightning-AI/lightning/pull/16423))
...
* `lightning.pytorch.strategies.fully_sharded_native.DDPFullyShardedNativeStrategy` is now `lightning.pytorch.strategies.fsdp.FSDPStrategy`
* `lightning.pytorch.plugins.precision.fsdp_native_native_amp.FullyShardedNativeNativeMixedPrecisionPlugin` is now `lightning.pytorch.plugins.precision.fsdp.FSDPMixedPrecisionPlugin`
* `lightning.pytorch.plugins.precision.native_amp` is now `lightning.pytorch.plugins.precision.amp`
...
- Removed the `lightning.pytorch.lite` module in favor of `lightning.fabric` ([#15953](https://github.com/Lightning-AI/lightning/pull/15953))

- `nvidia/apex` removal ([#16149](https://github.com/Lightning-AI/lightning/pull/16149))

  - Removed `lightning.pytorch.plugins.NativeMixedPrecisionPlugin` in favor of `lightning.pytorch.plugins.MixedPrecisionPlugin`
  ...
  - Removed the `lightning.pytorch.plugins.ApexMixedPrecisionPlugin` class
  - Removed the `lightning.pytorch.utilities.enums.AMPType` enum
...
- `FairScale` removal (in favor of PyTorch's FSDP implementation) ([#16400](https://github.com/PyTorchLightning/pytorch-lightning/pull/16400))
  ...
  - Removed the `lightning.pytorch.overrides.fairscale.LightningShardedDataParallel` class
  - Removed the `lightning.pytorch.plugins.precision.fully_sharded_native_amp.FullyShardedNativeMixedPrecisionPlugin` class
  - Removed the `lightning.pytorch.plugins.precision.sharded_native_amp.ShardedNativeMixedPrecisionPlugin` class
  - Removed the `lightning.pytorch.strategies.fully_sharded.DDPFullyShardedStrategy` (fsdp) class
  - Removed the `lightning.pytorch.strategies.sharded.DDPShardedStrategy` (ddp_sharded) class
  - Removed the `lightning.pytorch.strategies.sharded_spawn.DDPSpawnShardedStrategy` (ddp_sharded_spawn) class
...
- Removed the deprecated `lightning.pytorch.utilities.AllGatherGrad` class ([#16360](https://github.com/Lightning-AI/lightning/pull/16360))

- Removed the deprecated `resume_from_checkpoint` Trainer argument ([#16167](https://github.com/Lightning-AI/lightning/pull/16167))

- Removed the deprecated `lightning.pytorch.profiler` module ([#16359](https://github.com/Lightning-AI/lightning/pull/16359))
...
- Mark the `forward_module` argument as required ([#16386](https://github.com/Lightning-AI/lightning/pull/16386))
  ...
  - Removed the deprecated `lightning.pytorch.overrides.base.unwrap_lightning_module` function
  - Removed the `lightning.pytorch.overrides.distributed.LightningDistributedModule` class
  - Removed the deprecated `lightning.pytorch.overrides.fairscale.unwrap_lightning_module_sharded` function
  - Removed the `lightning.pytorch.overrides.fairscale.LightningDistributedModule` class
...
- Removed the deprecated automatic GPU selection ([#16184](https://github.com/Lightning-AI/lightning/pull/16184))
  ...
  - Removed the `lightning.pytorch.tuner.auto_gpu_select.{pick_single_gpu,pick_multiple_gpus}` functions
...
- Removed special support for truncated backpropagation through time (TBPTT) ([#16172](https://github.com/Lightning-AI/lightning/pull/16172))
  ...
  - Removed the `lightning.pytorch.loops.batch.TrainingBatchLoop`
...
- Deprecated `lightning.pytorch.profiler` in favor of `lightning.pytorch.profilers` ([#16059](https://github.com/Lightning-AI/lightning/pull/16059))
- Deprecated `Trainer(auto_select_gpus=...)` in favor of `lightning.pytorch.accelerators.find_usable_cuda_devices` ([#16147](https://github.com/Lightning-AI/lightning/pull/16147))
- Deprecated `lightning.pytorch.tuner.auto_gpu_select.{pick_single_gpu,pick_multiple_gpus}` in favor of `lightning.pytorch.accelerators.find_usable_cuda_devices` ([#16147](https://github.com/Lightning-AI/lightning/pull/16147))
- `nvidia/apex` deprecation ([#16039](https://github.com/Lightning-AI/lightning/pull/16039))
  ...
  - Deprecates the `lightning.pytorch.utilities.enums.AMPType` enum
...
- Deprecated `lightning.pytorch.lite.LightningLite` in favor of `lightning.fabric.Fabric` ([#16314](https://github.com/Lightning-AI/lightning/pull/16314))
- `FairScale` deprecation (in favor of PyTorch's FSDP implementation) ([#16353](https://github.com/Lightning-AI/lightning/pull/16353))
  - Deprecated the `lightning.pytorch.overrides.fairscale.LightningShardedDataParallel` class
  - Deprecated the `lightning.pytorch.plugins.precision.fully_sharded_native_amp.FullyShardedNativeMixedPrecisionPlugin` class
  - Deprecated the `lightning.pytorch.plugins.precision.sharded_native_amp.ShardedNativeMixedPrecisionPlugin` class
  - Deprecated the `lightning.pytorch.strategies.fully_sharded.DDPFullyShardedStrategy` class
  - Deprecated the `lightning.pytorch.strategies.sharded.DDPShardedStrategy` class
  - Deprecated the `lightning.pytorch.strategies.sharded_spawn.DDPSpawnShardedStrategy` class
...
- Removed the deprecated `lightning.pytorch.profiler.*` classes in favor of `lightning.pytorch.profilers` ([#16059](https://github.com/Lightning-AI/lightning/pull/16059))
- Removed the deprecated `lightning.pytorch.utilities.cli` module in favor of `lightning.pytorch.cli` ([#16116](https://github.com/Lightning-AI/lightning/pull/16116))
- Removed the deprecated `lightning.pytorch.loggers.base` module in favor of `lightning.pytorch.loggers.logger` ([#16120](https://github.com/Lightning-AI/lightning/pull/16120))
- Removed the deprecated `lightning.pytorch.loops.base` module in favor of `lightning.pytorch.loops.loop` ([#16142](https://github.com/Lightning-AI/lightning/pull/16142))
- Removed the deprecated `lightning.pytorch.core.lightning` module in favor of `lightning.pytorch.core.module` ([#16318](https://github.com/Lightning-AI/lightning/pull/16318))
- Removed the deprecated `lightning.pytorch.callbacks.base` module in favor of `lightning.pytorch.callbacks.callback` ([#16319](https://github.com/Lightning-AI/lightning/pull/16319))
...
- Fixed the import of `lightning.pytorch` causing a warning 'Redirects are currently not supported in Windows or MacOs' ([#15610](https://github.com/Lightning-AI/lightning/pull/15610))
