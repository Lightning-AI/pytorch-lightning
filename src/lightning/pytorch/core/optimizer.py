...
class LightningOptimizer:
    ...
    def _to_lightning_optimizer(
        cls, optimizer: Optimizer | LightningOptimizer, strategy: pl.strategies.Strategy
    ) -> LightningOptimizer:
...
def _configure_optimizers(optim_conf: dict[str, Any] | list | Optimizer | tuple) -> tuple[list, list, str | None]:
