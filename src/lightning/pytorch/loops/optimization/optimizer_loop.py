...
from lightning.pytorch.loops.utilities import _block_parallel_sync_behavior, _build_training_step_kwargs
...
class _OptimizerLoop(_Loop):
    ...
    :meth:`~lightning.pytorch.core.module.LightningModule.training_step` method with the batch, the current batch index
