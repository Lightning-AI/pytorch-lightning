...
from lightning_pytorch.core.optimizer import do_nothing_closure
from lightning_pytorch.loops import _Loop
from lightning_pytorch.loops.optimization.closure import OutputResult
from lightning_pytorch.loops.progress import _Progress, _ReadyCompletedTracker
...
class _ManualOptimization(_Loop):
    ...
    entirely in the :meth:`~lightning_pytorch.core.LightningModule.training_step` and therefore the user is responsible
    ...
    :meth:`~lightning_pytorch.core.LightningModule.training_step`) and passing through the output(s).
