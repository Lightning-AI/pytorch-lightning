...
def _log_device_info(trainer: "pl.Trainer") -> None:
    if CUDAAccelerator.is_available():
        ...
        gpu_available = True
        gpu_type = " (mps)"
    elif MUSAAccelerator.is_available():
        gpu_available = True
        gpu_type = " (musa)"
    else:
        gpu_available = False
    ...
    gpu_used = isinstance(trainer.accelerator, (CUDAAccelerator, MPSAccelerator, MUSAAccelerator))
    ...
    if (
        ...
        or MUSAAccelerator.is_available()
        and not isinstance(trainer.accelerator, MUSAAccelerator)
    ):
        rank_zero_warn(
