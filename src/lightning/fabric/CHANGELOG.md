...
- Added `lightning.fabric.plugins.Precision.module_init_context()` context manager to control the default tensor dtype during model instantiation ([#17462](https://github.com/Lightning-AI/lightning/pull/17462))
