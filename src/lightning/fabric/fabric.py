...
class Fabric:
    ...
    def clip_gradients(
        ...
        optimizer: Optional optimizer. If passed, clipping will be applied to only the parameters that the optimizer
            is referencing.
        clip_val: If passed, gradients will be clipped to this value.
        max_norm: If passed, clips the gradients in such a way that the p-norm of the resulting parameters is no larger
