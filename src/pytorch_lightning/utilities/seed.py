...
def seed_everything(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        ...
        " removed in v1.10.0. Please use `lightning_fabric.utilities.seed.seed_everything` instead."
    )
...
def reset_seed() -> None:
    rank_zero_deprecation(
        ...
        " removed in v1.10.0. Please use `lightning_fabric.utilities.seed.reset_seed` instead."
    )
...
def pl_worker_init_function(*args: Any, **kwargs: Any) -> None:
    rank_zero_deprecation(
        ...
        " removed in v1.10.0. Please use `lightning_fabric.utilities.seed.pl_worker_init_function` instead."
    )
