...
class PyTorchProfiler(Profiler):
    ...
    def __init__(
        ...
        **profiler_kwargs: Any,
        ...
        """Uses the low-level PyTorch profiler API :class:`torch.profiler._KinetoProfile`.

        It lets you inspect the cost of different operators inside your model - both on the CPU and GPU.
        ...
        # calculate the warmup and active step
