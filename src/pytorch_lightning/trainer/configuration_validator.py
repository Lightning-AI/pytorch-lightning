...
def __verify_train_val_loop_configuration(trainer: "pl.Trainer", model: "pl.LightningModule") -> None:
    ...
    if callable(getattr(model, "training_epoch_end", None)):
        raise NotImplementedError(
            ...
            " method. You can use the `on_train_epoch_end` hook instead. If you were using the `outputs` input argument"
            ", you can cache them in-memory by saving them as an instance attribute."
    ...
    if callable(getattr(model, "validation_epoch_end", None)):
        raise NotImplementedError(
            ...
            " method. You can use the `on_validation_epoch_end` hook instead. If you were using the `outputs` input"
            " argument, You can cache them in-memory by saving them as an instance attribute."
            " You can find migration examples in https://github.com/Lightning-AI/lightning/pull/16520."
        )
    ...
    if stage == "predict":
        ...
        if callable(getattr(model, epoch_end_name, None)):
            raise NotImplementedError(
                ...
                f" method. You can use the `on_{epoch_end_name}` hook instead. If you were using the `outputs` input"
                " argument, You can cache them in-memory by saving them as an instance attribute."
                " You can find migration examples in https://github.com/Lightning-AI/lightning/pull/16520."
            )
