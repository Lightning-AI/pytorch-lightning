...
- Tuner removal
  * Remove the deprecated `trainer.tuning` property ([#TODO](https://github.com/Lightning-AI/lightning/pull/TODO))
  * Removed the deprecated `TrainerFn.TUNING` and `RunningStage.TUNING` enums ([#TODO](https://github.com/Lightning-AI/lightning/pull/TODO))
