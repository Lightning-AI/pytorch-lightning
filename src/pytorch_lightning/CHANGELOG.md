...
- Removed the deprecated `pytorch_lightning.loops.base` module in favor of `pytorch_lightning.loops.loop` ([#16120](https://github.com/PyTorchLightning/pytorch-lightning/pull/16120))
