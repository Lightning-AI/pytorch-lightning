...
- Removed the deprecated device attributes `Trainer.{devices,num_gpus,ipus,tpu_cores}` in favor of the accelerator-agnostic `Trainer.num_devices` ([#xxxx](https://github.com/Lightning-AI/lightning/pull/xxxx))


- Removed the deprecated `Trainer.root_gpu` attribute in favor of `Trainer.strategy.root_device` ([#xxxx](https://github.com/Lightning-AI/lightning/pull/xxxx))
