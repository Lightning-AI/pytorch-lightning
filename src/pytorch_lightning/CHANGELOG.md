...
- Removed the deprecated `pytorch_lightning.core.lightning` module in favor of `pytorch_lightning.core.module` ([#16142](https://github.com/PyTorchLightning/pytorch-lightning/pull/16142))
