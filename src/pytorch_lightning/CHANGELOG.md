...
- Tuner now supports a new `method` argument which will determine when to run the `BatchSizeFinder`, during `fit`, `validate`, `test` or `predict` ([#11089](https://github.com/PyTorchLightning/pytorch-lightning/pull/11089))
