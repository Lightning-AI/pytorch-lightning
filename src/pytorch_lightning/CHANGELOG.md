...
- Added an argument `include_cuda` in `pytorch_lightning.utilities.seed.isolate_rng` to disable managing `torch.cuda`'s rng ([#15580](https://github.com/Lightning-AI/lightning/pull/15580))
