...
- Removed the depricated `Trainer.data_parallel_device_ids` function in favour of `Trainer.device_ids` ((#14422)[https://github.com/Lightning-AI/lightning/pull/14422])
