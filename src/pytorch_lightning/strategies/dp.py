...
class DataParallelStrategy(ParallelStrategy):
    ...
    def setup(self, trainer: "pl.Trainer") -> None:
        ...
        assert isinstance(self.model, pl.LightningModule), f"{self.model}"
        assert isinstance(self.model, (pl.LightningModule, _LightningPrecisionModuleWrapperBase)), f"{self.model}"
