...
from lightning_lite.accelerators.registry import AcceleratorRegistry
...
class AcceleratorConnector:
    ...
    def _check_and_init_precision(self) -> PrecisionPlugin:
        ...
        if isinstance(self.strategy, DeepSpeedStrategy):
            return DeepSpeedPrecisionPlugin(self._precision_flag, self._amp_type_flag, amp_level=None)  # type: ignore
