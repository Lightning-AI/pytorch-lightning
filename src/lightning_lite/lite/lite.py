...
from lightning_lite.lite.utilities import _AcceleratorType, _StrategyType, move_data_to_device
from lightning_lite.lite.utilities.apply_func import apply_to_collection, convert_to_tensors
