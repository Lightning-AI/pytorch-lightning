...
from lightning_lite.accelerators.registry import AcceleratorRegistry, call_register_accelerators  # noqa: F401
from lightning_lite.accelerators.tpu import TPUAccelerator  # noqa: F401

ACCELERATORS_BASE_MODULE = "lightning_lite.accelerators"
