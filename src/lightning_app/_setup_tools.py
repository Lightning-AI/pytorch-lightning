...
def _load_readme_description(path_dir: str, homepage: str, ver: str) -> str:
    ...
    # https://github.com/Lightning-AI/pytorch-lightning/raw/master/docs/source-app/_images/lightning_module/pt_to_pl.png
    github_source_url = os.path.join(homepage, "raw", ver)
    # replace relative repository path to absolute link to the release
    #  do not replace all "docs" as in the readme we reger some other sources with particular path to docs
    text = text.replace("docs/source-app/_static/", f"{os.path.join(github_source_url, 'docs/source-app/_static/')}")
