...
- Added a signal handler compose to enable signals enabling several frameworks to register signals ([#15807](https://github.com/Lightning-AI/lightning/pull/15807))
