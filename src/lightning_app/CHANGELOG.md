...
- Resolved a bug where install command was not installing the latest version of app/component be default ([#14181](https://github.com/Lightning-AI/lightning/pull/14181))
