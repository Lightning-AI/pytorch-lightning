...
def _app_logs_reader(
    ...
    # handling of this marker was wrong. We need to mimic what the UI does here.
    # I have changed it to show the issue but this is not the solution :)
    user_log_start = "BEGIN USER_REQUIREMENTS_INSTALL SECTION"
    started = False
