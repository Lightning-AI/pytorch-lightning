...
class LightningModule(
    ...
    def lr_schedulers(self) -> Union[None, List[LRSchedulerPLType], LRSchedulerPLType]:
        ...
        """
        # TODO(fabric): Decide whether to expose lr_schedulers through the module
    ...
    def current_epoch(self) -> int:
        ...
        # TODO(fabric): Decide where the progress information should come from
        raise NotImplementedError("Not supported in Fabric at the moment.")
    ...
    def logger(self) -> Optional[Logger]:
        ...
        # TODO(fabric): Decide how to expose logger references in the module
        raise NotImplementedError("Not supported in Fabric at the moment.")
    ...
    def configure_optimizers(self) -> Any:
        ...
        # TODO(fabric): This message needs to change
